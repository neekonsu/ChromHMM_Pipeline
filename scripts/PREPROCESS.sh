...
#Learn ChromHMM model with default parameters and paralellization
java -mx1600M -jar /usr/src/app/ChromHMM/ChromHMM.jar LearnModel -p 0 /usr/src/app/DATA/BINARIZED/ OUTPUTSAMPLE 15 hg19